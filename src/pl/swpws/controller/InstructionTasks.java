...
public class InstructionTasks {
    ...
    static class SeventhInstruction extends RootPage {
        ...
        private static final String MAIN_PAGE_INSTRUCTION_FEMALE = "Proszę sobie wyobrazić,\n" +
                "że kupuje Pani pralkę dla siebie.";
        private static final String MAIN_PAGE_INSTRUCTION_MALE = "Proszę sobie wyobrazić,\n" +
